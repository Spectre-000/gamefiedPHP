...
<head>
    ...
    <style>
        ...
        * {
        ...
        .toggle:checked + .slider + .card-side + .flip-card__inner {
            ...
            <label class="switch">
               ...
               <div class="flip-card__inner">
                  <div class="flip-card__front">
                     ...
                     <form class="flip-card__form" action="validate_user.php" method="post">
                  ...
                  <div class="flip-card__back">
                     ...
                     <form class="flip-card__form" action="add_user.php" method="POST">
                        ...
                        <input class="flip-card__input" id="password" name="password" placeholder="Password" type="password" required>
                        <input class="flip-card__input" id="confirmpassword" placeholder="Confirm Password" type="password">
                        <button class="flip-card__btn" id="submitBtn">Confirm!</button>
                     </form>
                  </div>
               </div>
            </label>
